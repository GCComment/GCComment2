...
const performFilteredExport = () => { console.info("performFilteredExport"); };
//TODO: Remove
const performFilteredDropboxExport = () => { console.info("performFilteredDropboxExport"); };
const storeToDropbox = () => { console.info("storeToDropbox"); };
...
export const generateExportDiv = () => {
    ...
    return html`
        <div id="exportDiv" style="display:none; margin:5px;padding:10px;outline:1px solid #D7D7D7;position:relative;background-color:#EBECED">                
            ${lang.export_step1}
            <div id="exportFilterStep1">                    
                ${appendCheckBox(EXPORT_FILTER_ALL, lang.all, toggleExportFilterOptions)}
            ...
            <div id="exportFilterStep2">
                ${
                    appendRadioGroup(EXPORT_FILTER_ARCHIVE, [{
                        label: lang.both,
                    ...
                    }], GCC_getValue(EXPORT_FILTER_ARCHIVE, EXPORT_FILTER_ARCHIVE_BOTH))
                }
            </div>

            ${lang.export_step3}
            <div id="exportFilterStep3">
                <select id="exportTypeSelector" name="exportTypeSelector" size=1>
            ...
            <input id="exportButton" type="button" value="${lang.export_perform}" onclick=${performFilteredExport} style="margin:5px" />
            <input id="exportDropboxButton" type="button" value="${lang.export_toDropboxPerformFilteredExport}" onclick=${performFilteredDropboxExport} style="margin:5px" />
            <input id="dropboxExportLink" type="button" value="${lang.export_toDropbox}" onclick=${storeToDropbox} style="margin:5px" />
